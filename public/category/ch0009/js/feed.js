...
var Feed = function(flg) {
	this.urlList = {
		'bestseller' : "http://www.amazon.co.jp/rss/bestsellers/books/3198081/ref=pd_ts_rss_link",
		'gift' : "http://www.amazon.co.jp/rss/bestsellers/books/492392/ref=pd_ts_rss_link",
		'new1' : "http://www.amazon.co.jp/rss/bestsellers/books/893306/ref=pd_ts_rss_link",
		'new2' : "http://www.amazon.co.jp/rss/bestsellers/books/3198091/ref=pd_ts_rss_link",
		'new3' : "http://www.amazon.co.jp/rss/bestsellers/books/492394/ref=pd_ts_rss_link"
	}
			...
			for (i = 0; i < entryLen; i++) {
				...
				if (cnt) {
					...
					for (j = 0; j < eItemsLen; j++) {
						...
						htmlStr += ' <div class="' + this.container + '_entry_' + this.eItems[j] + '">\n';
