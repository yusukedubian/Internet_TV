...
var Feed = function(flg) {
	this.urlList = {
		'bestseller' : "http://www.amazon.co.jp/rss/bestsellers/books/466280/ref=pd_ts_rss_link",
		'gift' : "http://www.amazon.co.jp/rss/most-gifted/books/466280/ref=pd_mg_rss_link",
		'new1' : "http://www.amazon.co.jp/rss/new-releases/books/467238/ref=pd_nr_rss_link",
		'new2' : "http://www.amazon.co.jp/rss/new-releases/books/467240/ref=pd_nr_rss_link",
		'new3' : "http://www.amazon.co.jp/rss/new-releases/books/508086/ref=pd_nr_rss_link"
	}
				...
				if (cnt) {
					...
					for (j = 0; j < eItemsLen; j++) {
						...
						if (this.container == "new1"||this.container == "new2"||this.container == "new3"){
							htmlStr += ' <div class="' + this.container + '_entry_' + this.eItems[j] + '" style="width:160px; height:33px; overflow:hidden; color:#FFFFFF;">\n';
						}
						else{
							htmlStr += ' <div class="' + this.container + '_entry_' + this.eItems[j] + '" style="color:#FFFFFF;">\n';
						}
