...
function FlightBoard() {
	this._defaults = {
		lettersImage: 'javascripts/flightBoardSmall.png', // Amalgamated image for letters background
		lettersSize: [14, 18], // Width and height of individual letters
		...
		maxLength: 10, // Maximum length of flight board
		...
		speed: 900, // Time taken (milliseconds) for a single transition
