...
(function(d){
    d.widget("ui.sortable", d.ui.mouse, {
            ...
            if (a) {
                ...
                if (this.options.revert) {
                    ...
                    d(this.helper).animate({
                        left: b.left - this.offset.parent.left - c.margins.left +
                        (this.offsetParent[0] ==
        ...
        _intersectsWith: function(a){
            ...
            return this.options.tolerance == "pointer" || this.options.forcePointerForContainers || this.options.tolerance != "pointer" && this.helperProportions[this.floating ? "width" : "height"] > a[this.floating ? "width" : "height"] ? j : g <
            b +
                ...
                c.placeholder = {
                    ...
                    update: function(f, g){
                        if (!(e && !c.forcePlaceholderSize)) {
							//alert("846行\nc.forcePlaceholderSize ==== "+c.forcePlaceholderSize);
                            g.height() ||
        ...
        _convertPositionTo: function(a, b){
            ...
            return {
                ...
                (d.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : e ? 0 : c.scrollTop()) * a),
        ...
        _generatePosition: function(a){
            ...
            d.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, e = /(html|body)/i.test(c[0].tagName);
...
.call(this, this.containers[e]));
                if (this.containers[e].containerCache.over) {
                    c.push(function(f){
                        return function(g){
                            f._trigger(" ", g, this._uiHash(this));
                        }
                    }
.call(this, this.containers[e]));
                    this.containers[e].containerCache.over = 0
